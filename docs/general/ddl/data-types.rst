...
Compound types are :ref:`nonscalar <gloss-nonscalar>` values that are composed
out of distinct parts like containers or collections:
...
An object is a :ref:`compound data type <sql_ddl_datatypes_compound>` and is
...
An array is a :ref:`compound data type <sql_ddl_datatypes_compound>` and is
